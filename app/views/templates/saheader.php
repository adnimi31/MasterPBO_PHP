...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
  <a class="navbar-brand" href="<?=BASEURL ?>/sadashboard">AM MVC</a>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="<?=BASEURL ?>/sadashboard">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?=BASEURL; ?>/sadashboard/about">About</a>
      </li>
      <li class="nav-item">
